    ...
    return (
      ...
      <div className="navbar" style={{ backgroundColor:'#4CAF50', color:'#fff', padding:'15px', display:'flex', justifyContent:'space-between', alignItems:'center', fontSize:'20px' }}>
        <div className="luxury">
          ...
          <a href="/" onClick={(e)=>{e.preventDefault(); onHomeClick();}} style={{color:'#fff', textDecoration:'none'}}>
            <h3>Paradise Nursery</h3>
            <i>Where Green Meets Serenity</i>
          </a>
        </div>
        <div style={{display:'flex', gap:'20px'}}>
          <a href="#" onClick={(e)=>{e.preventDefault(); setShowPlants(true); setShowCart(false);}} style={{color:'#fff', textDecoration:'none', fontSize:'24px'}}>Plants</a>
          <a href="#" onClick={(e)=>{e.preventDefault(); setShowCart(true);}} style={{color:'#fff', textDecoration:'none', fontSize:'24px'}}>
